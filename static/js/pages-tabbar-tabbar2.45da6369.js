            ...
            methods: {
                ...
                showModal: function() {
                    uni.showModal({
                        title: "公告",
                        showCancel: !1,
                        content: "BBOX 无损挖矿BNB，正式上线。\r\n1.投入0.02BNB 即可开始挖矿，24小时后可以提取到至少价值约0.05BNB的BBOX。\r\n2.随着挖矿人数的增加，产量会逐步降低，请关注网站最新公告。\r\n3.邀请好友一起挖矿，一级奖励10% BNB，二级奖励5% BNB  ",
                        success: function(t) {
                ...
                claim1: function() {
                    var t = this;
					console.log('claim1'),
                    o && (t.minerConf.realunclaim < 3000  ? uni.showToast({
                        title: "满3000个才能提现",
                        icon: "error",
                        duration: 5e3
    ...
    c313: function(t, e, n) {
        ...
        var a = {
          ...
          , i = function() {
            ...
            }, [t._v(t._s(t.minerConf.realunclaim) + " BBOX")])], 1), a("v-uni-view", {
                staticClass: "flex-row-around",
                staticStyle: {
                    "padding-top": "40rpx"
                }
